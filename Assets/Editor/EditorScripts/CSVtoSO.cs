...
{
    private static string weaponCSVPath = "/Editor/CSV/WeaponCSVs.csv"; // tell editor where file is
    private static string potionsCSVPath = "/Editor/CSV/ItemCSV.csv";
    private static string spritesPath = "Assets/Sprites/tilemap_packed.png";
    private static string difficultyPath = "/Editor/CSV/DifficultyLevelCSVs.csv";
    private static string characterPath = "/Editor/CSVPlayerTemplate.csv";
   ...
   public static void GenerateWeapon()

    {
        ...
        for (int i = 1; i < allLines.Length; i++) // to read lines from csv
        {
            ...
            AssetDatabase.CreateAsset(weapon, $"Assets/ScriptableObjects/Weapons/{weapon.itemName}.asset"); // telling program where to save
        }
    ...
    public static void GeneratePotions()
    {
        ...
        for (int i = 1; i < allLines.Length; i++) // to read lines from csv
        {
            ...
            AssetDatabase.CreateAsset(thePotions, $"Assets/ScriptableObjects/Weapons/Potions/{thePotions.itemName}.asset"); // telling program where to save
        }
    ...
    public static void GenerateDifficulty()
    {
        ...
        for (int i = 1; i < allLines.Length; i++) // to read lines from csv
        {
            ...
            AssetDatabase.CreateAsset(theDifficulty, $"Assets/ScriptableObjects/Difficulty/{theDifficulty.difficultyID}.asset"); // telling program where to save
        }
    ...
    public static void GenerateCharacter()
    {
        ...
        for (int i = 1; i < allLines.Length; i++) // to read lines from csv
        {
            ...
            AssetDatabase.CreateAsset(thePlayer, $"Assets/ScriptableObjects/Characters/{thePlayer.characterName}.asset"); // telling program where to save
        }
